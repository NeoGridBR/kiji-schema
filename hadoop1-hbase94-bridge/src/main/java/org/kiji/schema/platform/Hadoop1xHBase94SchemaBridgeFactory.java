...
public final class Hadoop1xHBase94SchemaBridgeFactory extends SchemaPlatformBridgeFactory {
  ...
  public int getPriority(Map<String, String> runtimeHints) {
    ...
    if (hadoopVer.matches("2\\..*-cdh4\\..*") && hbaseVer.matches("0\\.94\\.[0-9].+")) {
      // Hadoop 2.x.x and HBase 0.94.x match correctly; use this bridge.
      return Priority.NORMAL;
    } else if (hadoopVer.matches("1\\.[0-9\\.]+") && hbaseVer.matches("0\\.94\\.[0-9].+")) {
